...
namespace SignalRApi.Hubs
{
	public class SignalRHub:Hub
	{
        ...
        public async Task SendStatistic()
		{
			...
			var value7 = _productService.TProdcutPriceAvg();
			await Clients.All.SendAsync("ReceiveProdcutPriceAvg", value7.ToString("0.00") + "₺");
		...
		public async Task SendProgress()
		{
            ...
            var value5 = _productService.TProdcutPriceAvg();
